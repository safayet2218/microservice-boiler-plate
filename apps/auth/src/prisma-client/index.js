...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/auth/src/prisma-client",
    "auth/src/prisma-client",
  ]
...
path.join(process.cwd(), "apps/auth/src/prisma-client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/auth/src/prisma-client/schema.prisma")
