...
(function (ServiceNames) {
    ...
    ServiceNames["NOTIFICATIONS"] = "NOTIFICATIONS_SERVICE";
...
(function (MessagePatterns) {
    ...
    MessagePatterns["SEND_WELCOME_EMAIL"] = "send_welcome_email";
    MessagePatterns["SEND_ORDER_CONFIRMATION"] = "send_order_confirmation";
...
__exportStar(__webpack_require__(/*! ./utils */ "./libs/common/shared/src/utils.ts"), exports);
...
/***/ "./libs/common/shared/src/utils.ts":
/*!*****************************************!*\
  !*** ./libs/common/shared/src/utils.ts ***!
  \*****************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.throwRpcError = throwRpcError;
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
function throwRpcError(message, status) {
